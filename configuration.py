...
formatter_info_start = logging.Formatter('time: %(asctime)s, file: %(filename)s, func: %(funcName)s, level: %(levelname)s, module: %(module)s, msecs: %(msecs)d, msg: %(message)s, logger: %(name)s' + '\n---')
formatter_info_end = logging.Formatter('time: %(asctime)s, file: %(filename)s, func: %(funcName)s, level: %(levelname)s, module: %(module)s, msecs: %(msecs)d, output: %(message)s, logger: %(name)s' + '\n---------')

#warning
formatter_warn = logging.Formatter('time: %(asctime)s, file: %(filename)s, func: %(funcName)s, level: %(levelname)s, line: %(lineno)d, module: %(module)s, msecs: %(msecs)d, msg: %(message)s, logger: %(name)s, path: %(pathname)s' + '\n!!!!!!!!!')
...
formatter_fatal = logging.Formatter('time: %(asctime)s, file: %(filename)s, func: %(funcName)s, level: %(levelname)s, line: %(lineno)d, module: %(module)s, msecs: %(msecs)d, msg: %(message)s, logger: %(name)s, path: %(pathname)s, procID: %(process)d, proc: %(processName)s, threadID: %(thread)d, thread: %(threadName)s' + '\n$$$$$$$$$')
